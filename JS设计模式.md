...
### 什么是设计模式？
		...
		实际情况：
			...
			设计模式绝对不是纸上谈兵的知识，只是看书就以为自己懂了，那只是井底之蛙之见，设计模式绝对是从实践中来到实践中去的！
...
### 观察者模式（发布订阅模式）
		...
		应用场景：
			...
			比如小A，小B，小C都订阅了我的博客，当我的博客一有更新时，就会统一发布邮件给他们这三个人，就会通知这些订阅者。
...
### 模板模式
		...
		应用场景：
			...
			需要更改业务逻辑的部分或者重新添加新业务的情况。主要是通过子类来改写父类的情况，其他不需要改变的部分继承父类。
...
### 代理模式
		...
		代码实现：
			...
			比如我们公司的补打卡是最后是要交给大boss来审批的，但是公司那么多人，每天都那么多补打卡，那大boss岂不是被这些琐事累死。
