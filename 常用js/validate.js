const MOBILE_REG = /^1[3|4|5|8|7|9][0-9]\d{8}$/, //验证手机号
    EMAIL_REG = /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/, //验证邮箱
    MONEY_REG = /^([1-9][\d]{0,7}|0)(\.[\d]{1,2})?$/, //验证RMB
    NAME_REG = /^([\u4e00-\u9fa5]+|[a-zA-Z0-9]+)$/, //名字（包括中文、英文、数字）
    CHINESE_REG = /^[\u4e00-\u9fa5]+$/, //名字（中文）
    BANKNO_REG = /^\d{16,19}$/, //银行卡号
    PWD_REG = /(\d(?!\d{5})|[A-Za-z](?![A-Za-z]{5})){6}/; //六位密码（包含英文、数字）
