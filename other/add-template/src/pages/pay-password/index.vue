<template>
  <div class="pay_password">
    <h3 class="login">设置支付密码</h3>
    <div class="options">
      <p>设置密码</p>
      <input type="number" placeholder="请输入6位数支付密码" maxlength="6" v-model="authTel" password="true">
    </div>
    <div class="options">
      <p>再次输入</p>
      <input type="number" placeholder="请再输入一遍" v-model="authVal" maxlength="6" password="true">
    </div>
    <button class="btn" plain="true" hover-class="none" open-type="getUserInfo" @getuserinfo="getInfo" style="color:#fff;">确认领卡</button>
  </div>
</template>
