    ...
    <div class="store_deploy_top">
      <ul class="deploy_list">
        <li v-for="(v,i) in deployList" :key="i" :data-item="v" :data-index="i" @click='checkItem(v)' :style="{marginLeft:v.Leftv+'px'}">
          ...
          <input type='text' @focus="inpFocus(v,i)" :class="{input_dis:indexBlock!=1}" placeholder="请输入分类名称" maxlength="8" :disabled='indexBlock!=1' placeholder-class='placeholderStyle' v-model='v.TypeName'>
