        ...
        <div v-if='!isEmitImg' style="height:100%;">
            <div class="wrap">
                ...
                <div class="main goodsImg">
                    ...
                    <div class="detailImg" :class="{defaultImg:goodsInfo.GoodPics.length == 0}">
        ...
        methods: {
            ...
            getClass() {
                this.util.post({
                    ...
                    if (res.Body.length > 0) {
                        ...
                        /* 新建商品，默认选择第一项商品分类 */
                        if (this.goodsInfo.GoodId == 0) {
                            if (wx.getStorageSync('typeSet')) {
                                this.goodsInfo.GoodType = wx.getStorageSync('typeSet').GoodType;
                                this.goodsTypeName = wx.getStorageSync('typeSet').TypeName;
                                this.classListIndex = wx.getStorageSync('typeSet').Index;
                            } else {
                                console.log('新增选中第一项')
                                ...
                                let typeSet = {
                                    GoodType: res.Body[0].TypeId,
                                    TypeName: res.Body[0].TypeName,
                                    Index: 0
                                };
                                wx.setStorageSync('typeSet', typeSet)
                            }
            ...
            okType() {
                ...
                let typeSet = {
                    ...
                    TypeName: this.classList[this.classListIndex].TypeName,
                    Index: this.classListIndex
                };
                wx.setStorageSync('typeSet', typeSet)
            },
            confState() {
