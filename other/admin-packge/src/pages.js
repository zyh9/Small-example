module.exports = [
  ...
  {
    path: 'pagesUser/admin-online-retailers',
    subPackage: true,
    config: {
      navigationBarTitleText: '模板配置'
    }
  },
  {
    path: 'pagesUser/admin-set-banner',
    subPackage: true,
    config: {
      navigationBarTitleText: '头部图配置'
    }
  },
  {
    path: 'pagesUser/admin-set-nav',
    subPackage: true,
    config: {
      navigationBarTitleText: '小图区配置'
    }
  },
  {
    path: 'pagesUser/admin-set-ad',
    subPackage: true,
    config: {
      navigationBarTitleText: '广告图配置'
    }
  },
  {
    path: 'pagesUser/admin-jump-type',
    subPackage: true,
    config: {
      navigationBarTitleText: '跳转配置'
    }
  },
  ...
  {
    path: 'pagesMoney/admin-member-set',
    subPackage: true,
    config: {
      navigationBarTitleText: '会员卡配置',
    }
  },
  {
    path: 'pagesMoney/admin-member-list',
    subPackage: true,
    config: {
  ...
  {
    path: 'pagesMoney/admin-member-detail',
    subPackage: true,
    config: {
  ...
  {
    path: 'pagesMoney/admin-member-config',
    subPackage: true,
    config: {
  ...
  {
    path: 'pagesMoney/admin-member-info',
    subPackage: true,
    config: {
      navigationBarTitleText: '会员卡信息',
    }
  },
  {
    path: 'pagesMoney/admin-member-style',
    subPackage: true,
    config: {
      navigationBarTitleText: '会员卡样式',
    }
  },
  {
    path: 'pagesMoney/admin-member-personInfo',
    subPackage: true,
    config: {
