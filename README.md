...
### vue实现九宫格抽奖
		...
		利用延时和重复定时器来控制抽奖速度的变化
		
		虽说方法有些差强人意，但还是实现了最基本的功能
	...
	export default {
        data() {
            return {
                ...
                list: [{
                        img: '/assets/img1/rmb5.png',
                        info: '5元代金券',
                        txt1: '恭喜您，获得5元代金券',
                        txt2: '快去使用吧'
                    },
                    {
                        img: '/assets/img1/rmb10.png',
                        info: '10元代金券',
                        txt1: '恭喜您，获得10元代金券',
                        txt2: '快去使用吧'
                    },
                    {
                        img: '/assets/img1/participate.png',
                        info: '谢谢参与',
                        txt1: '很遗憾，未中奖',
                        txt2: '再接再厉'
                    },
                ...
                text2: '',
                maskImg: null, //弹窗获奖图片
                over: '/assets/img1/over.png', //无抽奖次数弹窗图片
                notWinning: '/assets/img1/notWinning.png', //未中奖弹窗图片
                templates: [{
                        activityTitle: '活动模板一',
                        conBg: '/assets/img1/bg.png', //背景图片
                        lotteryBg: 'assets/img1/lotterybg.png', //抽奖背景图片
                        itemBg: 'assets/img1/normal.png', //未选中背景图片
                        clickBg: '/assets/img1/click.png', //立即抽奖背景图片
                        checkedBg: '/assets/img1/checked.png', //已选中背景图片
                        maskBg: '/assets/img1/mask.png', //弹窗背景图片
                        bgColor: '#660e88', //皮肤底色
                        bannerImg: '/assets/img1/banner.png', //标题img
                        ruleImg: '/assets/img1/article.png', //规则img
                        bgMusic: '/assets/img1/石久让-天空之城.mp3', //背景音乐
                        play: '/assets/img1/play.png', //背景音乐播放img
                        mute: '/assets/img1/pause.png', //背景音乐暂停img
                    ...
                    {
                        activityTitle: '活动模板二',
                        conBg: '/assets/img2/bg.png', //背景图片
                        lotteryBg: 'assets/img2/lotterybg.png', //抽奖背景图片
                        itemBg: 'assets/img2/normal.png', //未选中背景图片
                        clickBg: '/assets/img2/click.png', //立即抽奖背景图片
                        checkedBg: '/assets/img2/checked.png', //已选中背景图片
                        maskBg: '/assets/img2/mask.png', //弹窗背景图片
                        bgColor: '#ffe433', //皮肤底色
                        bannerImg: '/assets/img2/banner.png', //标题img
                        ruleImg: '/assets/img2/article.png', //规则img
                        bgMusic: '/assets/img2/石久让-天空之城.mp3', //背景音乐
                        play: '/assets/img2/play.png', //背景音乐播放img
                        mute: '/assets/img2/pause.png', //背景音乐暂停img
